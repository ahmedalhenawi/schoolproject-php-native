...
?>
    ...
    include_once("partial/nav.php")
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div class="d-flex">
                    <div class="mr-auto p-2"><h1 class="h3 mb-4 text-gray-800">Add New Teacher</h1></div>
                    <div class="p-2"><a href="show_teachers.php" class=" btn btn-primary mr-4">show all Teachers</a></div>
                    </div>
