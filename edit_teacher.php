  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES['img']['name'])){
        ...
        if ($file_ext == "png" || $file_ext == "jpg"){
            ...
            $img_new_name = "teacher_".strval(time()+rand(1,1000)) . ".$file_ext" ;
    ...
    if(empty($errors)){
        ...
        $query = "update teacher set name = '$name' , email = '$email'  ,phone = '$phone'  , img = '$img_new_name'  where id = '$id'" ;
...
?>
    ...
    include_once("partial/nav.php")
                ...
                ?>
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']."?id=$id" ?>" class="mr-1" method="POST" enctype="multipart/form-data">
