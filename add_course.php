...
?>
    ...
    include_once("partial/nav.php")
                ...
                <div class="d-flex">
                    <div class="mr-auto p-2"><h1 class="h3 mb-4 text-gray-800">Add New Course</h1></div>
                    <div class="p-2"><a href="show_courses.php" class=" btn btn-primary mr-4">show all Courses</a></div>
                    </div>
                            ...
                            <div class="form-group mt-3 ">
                              <label for="select_teacher">Select Teacher</label>
                                        <select class="custom-select" id="select_teacher" name="teacher_id" required>
                                          ...
                                          <?php
                                                $c_query ='select id , name from teacher' ;
